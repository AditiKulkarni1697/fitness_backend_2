...
app.get('/auth/google/callback',
  ...
  async(req, res) => {
      ...
      if(user){
        ...
        res.redirect(`https://splendorous-medovik-fa5d80.netlify.app/html/client.html?client=user&data=${user}`)
      }
      else{
        res.redirect("https://splendorous-medovik-fa5d80.netlify.app/html/signup.html")
      }
    }
    catch(err){
      console.log(err)
